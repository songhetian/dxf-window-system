...
const PricingPage = () => {
  ...
  const result = useMemo(() => {
    ...
    const baseValue = selectedProduct.pricingMode === 'area'
      ? area
      : selectedProduct.pricingMode === 'perimeter'
        ? perimeter
        : 1;
                ...
                {productSummary.map((product) => (
                  ...
                  >
                    <Stack gap="sm">
                      ...
                      <Group gap="xs">
                        <Badge variant="light">成本 {product.costEstimate.toFixed(2)}</Badge>
                        <Badge variant="light">售价 {product.retailEstimate.toFixed(2)}</Badge>
                      </Group>
                      <Text size="sm" c="dimmed">
